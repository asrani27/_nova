...
-- ----------------------------
BEGIN;
INSERT INTO `konsumen` (`id`, `alamat`, `nama`, `telp`, `created_at`, `updated_at`) VALUES (1, 'jl....', 'adi', '0987999', '2025-05-16 20:33:00', '2025-05-16 20:33:12');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `users` (`id`, `name`, `email`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `admin_layanan`) VALUES (1, 'superadmin', NULL, 'superadmin', '2025-05-16 20:03:07', '$2y$10$P4gUyBMc1HlYqHCspurbS.NLYM4GV.bG9ifsHntseApHjVD0QcY1S', 'FAYEijQx0AG22zaOrXJjGwnnC5MSuFenXmjlmielhbh3n0q0fjtaVHQI4Ai8', '2025-05-16 20:03:07', '2025-05-16 20:03:07', NULL);
...
INSERT INTO `users` (`id`, `name`, `email`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `admin_layanan`) VALUES (7, 'UMKM PONDOK JAMUR LILY', NULL, 'pu9', '2023-11-16 00:02:28', '$2y$10$iUL2WPb.nmlNS8XrV7h4.OvwA6VpkYJQIA4aMHXX3/S9XgsoJzCk.', 'MlqZ66cQV1DGQWLkNl7gdwHNMBU6xMxiRG8KDAy4AskvB7o8LpF5lg1roxy4', '2023-11-16 00:02:28', '2023-11-16 08:02:28', NULL);
