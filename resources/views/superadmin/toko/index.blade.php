    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Toko UMKM</h3>
                        ...
                        <tr style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
                            ...
                            <td>
                                ...
                                <form action="/superadmin/toko/{{$item->id}}" method="post">
                                    <a href="/superadmin/toko/{{$item->id}}/edit" class="btn btn-xs btn-success"><i
                                    ...
                                    <button type="submit" class="btn btn-xs btn-danger"
                                        ...
                                        Delete</button>
                                    @if ($item->user == null)
                                    <a href="/superadmin/toko/{{$item->id}}/akun" class="btn btn-xs btn-warning"><i
                                            class="fas fa-key"></i> Buat Akun</a>

                                    @else
                                    <a href="/superadmin/toko/{{$item->id}}/reset" class="btn btn-xs btn-info"><i
